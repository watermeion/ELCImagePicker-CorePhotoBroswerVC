...
//Modify By Guo Yubao  watermeion.github.io
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    GBALbumPickerCollectionViewController *picker = [[GBALbumPickerCollectionViewController alloc]initWithNibName:@"GBALbumPickerCollectionViewController" bundle:nil] ;
