...
//Modify by gyb  Guoyubao  watermeion.github.io
//修改cell大小 适配 4.7 inch iphone
//
//
//
//
...
- (id)init
{
    ...
    if (self) {
        ...
        self.columns = 4;
        self.cellWidth = ([UIScreen mainScreen].bounds.size.width/self.columns)- 4;
    }
    return self;
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.cellWidth = ([UIScreen mainScreen].bounds.size.width/4)- 4;
    self.columns = self.view.bounds.size.width / self.cellWidth ;
}
